...
```
##### Helm İnstallation Jenkins, Argocd, Prometheus Stack, Chartmuseum
[]()
 ```
  # This Applications use for CI
helm repo add jenkinsci https://charts.jenkins.io
helm install jenkins jenkinsci/jenkins -n jenkins --create-namespace


 # This Applications use for CD
kubectls create ns argocd
helm repo add argo https://argoproj.github.io/argo-helm
helm install argocd argo/argo-cd


# This Applications use for monitoring
...
# This Applications use for helm repository
helm repo add chartmuseum https://chartmuseum.github.io/charts
helm install helm-repo chartmuseum/chartmuseum

```

## Jenkins Configuration
We will do docker build and push operations with Kaniko without docker.
First, we create a Container Template.
![](https://miro.medium.com/v2/resize:fit:720/format:webp/1*MydwIO9goTM2KDMEdXn76w.png)

Then, we will create a secret from docker-config.json, which will enable our kaniko's auth transactions with registery.
...
```
##### Scan Docker İmage With Trivy
I install Trivy at that stage and use it there, as in the example below.
...
Here it creates a Container template again. 
...
Deploy the applications.yaml and registery yamls we created to the Kubernetes Cluster.
